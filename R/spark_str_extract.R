#'  Extract matching patterns from a Spark DataFrame's column.
#'
#' @description Return the first pattern match found in each string, as a Spark DataFrame's column.
